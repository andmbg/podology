...
# Connector:
# Specify class paths as strings. Open to adding more connectors and transcribers.
...
# If True, set the transcriber endpoint to "dummytranscribe" below.
DUMMY_AUDIO = False
